...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'prototype', '/wp-includes/js/google/prototype.js', array(), '1.7.1');
	$scripts->add( 'scriptaculous-root', '/wp-includes/js/google/scriptaculous.js', array('prototype'), '1.9.0');
	$scripts->add( 'scriptaculous-builder', '/wp-includes/js/google/builder.js', array('scriptaculous-root'), '1.9.0');
	$scripts->add( 'scriptaculous-dragdrop', '/wp-includes/js/google/dragdrop.js', array('scriptaculous-builder', 'scriptaculous-effects'), '1.9.0');
	$scripts->add( 'scriptaculous-effects', '/wp-includes/js/google/effects.js', array('scriptaculous-root'), '1.9.0');
	$scripts->add( 'scriptaculous-slider', '/wp-includes/js/google/slider.js', array('scriptaculous-effects'), '1.9.0');
	$scripts->add( 'scriptaculous-sound', '/wp-includes/js/google/sound.js', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-controls', '/wp-includes/js/google/controls.js', array('scriptaculous-root'), '1.9.0');
